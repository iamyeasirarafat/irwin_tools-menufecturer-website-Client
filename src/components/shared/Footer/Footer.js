...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y mt-20 bg-gray-800 text-gray-100">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">IRWIN Tools</span>
                        </a>
                    </div>
                ...
                <div className="py-6 text-sm text-center text-gray-400">© 2022 IRWIN Co. All rights reserved.</div>
            </footer>
        </div>
    );
};
